...
local function patchCoverBrowserStatusIcons(plugin)
    ...
    if not IconWidget.patched_new_status_icons then
        ...
        -- Override IconWidget.new to automatically add alpha
    ...
    if not MosaicMenuItem or MosaicMenuItem.patched_new_status_icons then
        return
    end
    MosaicMenuItem.patched_new_status_icons = true
